...
contract DexTest is Test {
    ...
    function testAddLiquidity2() external {
        ...
        uint256 secondLPReturn = dex.addLiquidity(
            1000 ether * 2,
            1000 ether * 2,
            0
        );
    ...
    function testSwap1() external {
        ...
        int256 expectedOutput = -(int256(poolAmountX * poolAmountY) /
            int256(poolAmountX + 300 ether)) + int256(poolAmountY);
    ...
    function testSwap2() external {
        ...
        int256 expectedOutput = -(int256(poolAmountY * poolAmountX) /
            int256(poolAmountY + 6000 ether)) + int256(poolAmountX);
        expectedOutput = (expectedOutput * 999) / 1000; // 0.1% fee
        uint256 uExpectedOutput = uint256(expectedOutput);
